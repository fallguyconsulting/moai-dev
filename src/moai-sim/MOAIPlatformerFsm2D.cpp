...
//		float dist = ZLDist::PointToPlane2D ( this->mLoc, surface );
...
//	}
//
//	ZLVec2D invMove = move;
//	invMove.Reverse ();
//
//	// head is at top of unit circle
//	ZLVec2D head = this->mLoc;
//	head.mY += 1.0f;
//
//	// foot is at bottom of unit circle
//	ZLVec2D foot = this->mLoc;
//	foot.mY -= 1.0f;
//	
//	ZLVec2D spine ( 0.0f, 2.0f );
//	
//	enum {
//		HEAD,
//		FOOT,
...
//			float uB;
//			
//			if ( ZLSect::RayToRay ( surface.mV0, invMove, foot, spine, time, uB ) == ZLSect::SECT_HIT ) {
...
//			}
//			
//			if ( ZLSect::RayToRay ( surface.mV1, invMove, foot, spine, time, uB ) == ZLSect::SECT_HIT ) {
//				if (( time >= 0.0f ) && ( time < hitTime )) {
//					hitTime = time;
//					hit = &surface;
//					contactType = SPINE;
...
//	
//	ZLVec2D move = this->mFloorTangent;
//	move.Scale ( moveDist );
